...
public class UDM_Menu extends JFrame {
   ...
   public UDM_Menu(String name, String adr) {
   	setIconImage(Toolkit.getDefaultToolkit().getImage(UDM_Menu.class.getResource("/img/logo.png")));
      setTitle("\uC6B0 . \uB3D9 . \uB9DB");
      ...
      lblNewLabel_4.setIcon(new ImageIcon(UDM_Menu.class.getResource("/bgimg/menu.png")));
      lblNewLabel_4.setBounds(0, 0, 584, 961);
      contentPane.add(lblNewLabel_4);
   }
   
   private void menu(JPanel panel, String name, String adr) {
      ...
      JLabel label = new JLabel("\uBD88\uACE0\uAE30 \uC815\uC2DD");
      ...
      JLabel label_1 = new JLabel("\uD55C\uC2DD\uAC00\uAC8C");
      label_1.setFont(new Font("±¼¸²", Font.BOLD, 35));
      label_1.setBounds(217, 66, 172, 70);
      ...
      JLabel label_2 = new JLabel("\uD314\uC0C9\uBE44\uBE54\uBC25");
      ...
      lblNewLabel_1.setIcon(new ImageIcon(UDM_Menu4.class.getResource("/img/\uBD88\uACE0\uAE30.jpg")));
      ...
      label_4.setIcon(new ImageIcon(UDM_Menu4.class.getResource("/img/\uBE44\uBE54\uBE71.jpg")));
      ...
      label_6 = new JLabel("8000");
      label_6.setHorizontalAlignment(SwingConstants.RIGHT);
      label_6.setFont(new Font("±¼¸²", Font.PLAIN, 13));
      label_6.setBounds(242, 398, 68, 21);
