...
public class UDM_Menu4 extends JFrame {
   ...
   public UDM_Menu4(String name, String adr) {
   	setIconImage(Toolkit.getDefaultToolkit().getImage(UDM_Menu4.class.getResource("/img/logo.png")));
      setTitle("\uC6B0 . \uB3D9 . \uB9DB");
      ...
      menu4(panel, name, adr);
      getContentPane().add(panel);
      
      JLabel lblNewLabel_9 = new JLabel("");
      lblNewLabel_9.setIcon(new ImageIcon(UDM_Menu4.class.getResource("/bgimg/menu.png")));
   ...
   private void menu4(JPanel panel, String name, String adr) {
      ...
      JLabel label = new JLabel("Æ¯º°ÃÊ¹ä");
      label.setFont(new Font("±¼¸²", Font.BOLD, 14));
      label.setBounds(242, 192, 116, 40);
      ...
      JLabel label_1 = new JLabel("\uC77C\uC2DD\uAC00\uAC8C");
      label_1.setFont(new Font("±¼¸²", Font.BOLD, 40));
      label_1.setBounds(207, 66, 172, 70);
      ...
      button_6.setBounds(306, 443, 56, 29);
      ...
      button_7.setBounds(432, 443, 58, 29);
      contentPane.add(button_7);
      
      label_3 = new JLabel("Ä¡Áîµ·±î½º");
      ...
      button_8.setBounds(432, 534, 95, 32);
      ...
      lblNewLabel_5 = new JLabel("7500");
      lblNewLabel_5.setFont(new Font("±¼¸²", Font.PLAIN, 13));
      lblNewLabel_5.setBounds(242, 398, 70, 21);
      ...
      lblNewLabel_8.setBounds(322, 562, 57, 20);
